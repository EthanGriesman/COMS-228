...
public class SimpleTests {
	public static void main(String[] args) {
        ...
        Point.xORy = false; // Reset xORy flag
     ...
     // Test Case 1: Sorting by x-coordinate
        Point[] points1 = { new Point(5, 2), new Point(1, 6), new Point(3, 4), new Point(2, 3) };
        testSelectionSort(points1, 0);

        // Test Case 2: Sorting by y-coordinate
        Point[] points2 = { new Point(5, 2), new Point(1, 6), new Point(3, 4), new Point(2, 3) };
        ...
        Point[] points4 = { new Point(4, 3) };
        testSelectionSort(points4, 1);

        // Test Case 5: Array with duplicate points by x-coordinate
        Point[] points5 = { new Point(2, 3), new Point(1, 2), new Point(2, 1), new Point(1, 4) };
        testSelectionSort(points5, 0);

        // Test Case 6: Array with duplicate points by y-coordinate
        Point[] points6 = { new Point(2, 3), new Point(1, 2), new Point(2, 1), new Point(1, 4) };
